...
<head>
  ...
  <title>Smart Water Tracker | Mailbox</title>
  ...
  <!-- Smart Water TrackerSkins. Choose a skin from the css/skins
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview php">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="mailbox.php">Inbox <span class="label label-primary pull-right">13</span></a>
            </li>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="read-mail.html">Mahitha Byreddy</a></td>
                    <td class="mailbox-subject"><b>Smart Water Tracker Issue</b> - Trying to find a solution to this problem...
                    </td>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016 <a href="">Smart Water Tracker</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- Smart Water Trackerfor demo purposes -->
