...
<head>
  ...
  <title>Smart Water Tracker | Flot Charts</title>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      ...
                      <h4>
                        Smart Water Tracker Design Team
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="flot.php"><i class="fa fa-circle-o"></i> Flow management</a></li>
          </ul>
        </li>
